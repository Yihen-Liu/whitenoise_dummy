...
type Negotiate struct {
	...
	Join        string `protobuf:"bytes,2,opt,name=join,proto3" json:"join,omitempty"` //join at this peerid
	SessionId   string `protobuf:"bytes,3,opt,name=sessionId,proto3" json:"sessionId,omitempty"`
	Destination string `protobuf:"bytes,4,opt,name=destination,proto3" json:"destination,omitempty"`
	Sig         []byte `protobuf:"bytes,5,opt,name=sig,proto3" json:"sig,omitempty"`
}

func (x *Negotiate) Reset() {
	*x = Negotiate{}
...
func (x *Negotiate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Negotiate) ProtoMessage() {}

func (x *Negotiate) ProtoReflect() protoreflect.Message {
	mi := &file_gossip_proto_msgTypes[0]
...
// Deprecated: Use Negotiate.ProtoReflect.Descriptor instead.
func (*Negotiate) Descriptor() ([]byte, []int) {
	return file_gossip_proto_rawDescGZIP(), []int{0}
}

func (x *Negotiate) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *Negotiate) GetJoin() string {
	if x != nil {
		return x.Join
	}
	return ""
...
func (x *Negotiate) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *Negotiate) GetDestination() string {
	if x != nil {
...
var file_gossip_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x67, 0x6f, 0x73, 0x73, 0x69, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02,
	0x70, 0x62, 0x22, 0x81, 0x01, 0x0a, 0x09, 0x6e, 0x65, 0x67, 0x6f, 0x74, 0x69, 0x61, 0x74, 0x65,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x69, 0x67, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x03, 0x73, 0x69, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
